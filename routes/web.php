...
Route::middleware(['auth'])->group(function ()
{
    ...
    Route::group(['prefix' => 'booking'], function ()
    {
        Route::get('/new/{packageId}', [App\Http\Controllers\BookingController::class, 'addbooking'])->name('addbooking');
        Route::post('/submitBooking', [App\Http\Controllers\BookingController::class, 'createBooking'])->name('submitBooking');
        Route::get('/blisting/{id?}', [App\Http\Controllers\BookingController::class, 'blisting'])->name('blisting');
        Route::get('/generateBookingVoucher/{id}', [App\Http\Controllers\BookingController::class, 'generateBookingVoucher'])->name('generateBookingVoucher');
        Route::get('/getBookingDetails/{id}', [App\Http\Controllers\BookingController::class, 'getBookingDetails'])->name('getBookingDetails');
        Route::get('/getTravellerDetails/{id}', [App\Http\Controllers\BookingController::class, 'getTravellerInformation'])->name('getTravellerInformation');
        Route::post('/addTicketInfomation', [App\Http\Controllers\BookingController::class, 'addTicketInfomation'])->name('addTicketInfomation');
    });
    ###############################################################################################################################################
    ##################################### Airline CRUD  ####################################################################################
    ...
    {
        Route::get('/booking/approve/{bookingId}', [App\Http\Controllers\BookingController::class, 'approveBooking'])->name('approveBooking');
        Route::get('/booking/reject/{bookingId}', [App\Http\Controllers\BookingController::class, 'rejectBooking'])->name('rejectBooking');
    });
    ...
    {
        Route::get('/bankDetails', [App\Http\Controllers\BankDetailsController::class, 'getBankDetails'])->name('getBankDetails');
        Route::post('/addBankDetails', [App\Http\Controllers\BankDetailsController::class, 'addBankDetails'])->name('addBankDetails');
        Route::post('/toggleBankStatus', [App\Http\Controllers\BankDetailsController::class, 'toggleBankStatus'])->name('toggleBankStatus');
        Route::post('/deleteBankStatus', [App\Http\Controllers\BankDetailsController::class, 'deleteBankStatus'])->name('deleteBankStatus');
    });
});
// Route::post('/bank/addBankDetails', [App\Http\Controllers\BankDetailsController::class, 'addBankDetails'])->name('addBankDetails');
