                ...
                <div class="tm_invoice_in">
                    ...
                    <div class="tm_invoice_info tm_mb30">
                        ...
                        <div class="tm_invoice_info_list">
                            <p class="tm_invoice_number tm_m0">Booking No: <b class="tm_primary_color">#{{$bookingMaster->id}}</b></p>
                            <p class="tm_invoice_date tm_m0">Booking Date: <b class="tm_primary_color">{{$bookingMaster->booking_date}}</b>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="tm_grid_row tm_col_4 tm_col_2_md tm_invoice_info_in tm_gray_bg tm_mb30 tm_round_border">
                        ...
                        <div>
                            ...
                            <span class="tm_primary_color">{{$bookingMaster->primary_traveller_contact_number}}</span>
                        </div>
                        <div>
                            <span>Email</span> <br>
                    ...
                    <div class="tm_table tm_style1 tm_mb30">
                        <h2 class="tm_f16 tm_section_heading tm_border_color tm_mb15"><span class="tm_gray_bg">Airline Information</span></h2>
                    ...
                    <h2 class="tm_f16 tm_section_heading tm_border_color tm_mb15"><span class="tm_gray_bg">Hotel
                        ...
                        <div class="tm_invoice_info tm_mb25">
                          ...
                          <h2 class="tm_f16 tm_section_heading tm_border_color tm_mb15"><span class="tm_gray_bg">Passenger Information</span></h2>
                                      ...
                                      <table>
                                          ...
                                          <tbody>
                                              <tr>
                                                  ...
                                                  <td class="tm_border_left"><b class="tm_primary_color">Payment Gatway:</b>
                                                      American Express</td>
                                                  <td class="tm_border_left"><b class="tm_primary_color">Passenger Name:</b> Jhon Doe</td>
                                                  <td class="tm_border_left"><b class="tm_primary_color">Payment Gatway:</b>
                                                      American Express</td>
                                              </tr>
                          ...
                          <p class="tm_m0 tm_text_center tm_primary_color">Thank you for purchasing the ticket, have a safe
                        journey 🙂</p>
                </div>
            </div>
