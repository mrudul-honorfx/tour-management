        ...
        <div class="col-6">
            <div class="card">
                ...
                <div class="alert alert-success">
                    ...
                    @endif
                <div class="card-body">
                    <h4 class="card-title mb-3">Add Airline Provider</h4>
                    ...
                    <form class="needs-validation " novalidate action="{{ route('addRoomTypes.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label" for="validationCustom01">Airline Provider</label>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-editable table-nowrap align-middle table-edits">
                            ...
                            <tbody>
                                @foreach($airlineProviders as $index => $provider)
                                <tr data-id="{{ $index + 1 }}">
                                    ...
                                    <td style="width: 100px">
                                        {{-- <button type="button" class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#editModal{{ $room_type->id }}">
                                          ...
                                          <button type="button" class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#delteModal{{ $provider->id }}">
                                            <i class="fas fa-trash-alt"></i>
                                          </button>
                                        
                                    </td>
                                </tr>
                                <div class="modal fade" id="delteModal{{ $provider->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                          ...
                                          <form action="{{ route('deleteRoomType', ['id' => $provider->id]) }}" method="POST">
                                              @csrf
                                              @method('DELETE')
