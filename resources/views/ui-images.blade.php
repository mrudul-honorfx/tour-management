    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img class="rounded me-2" alt="200x200" width="200" src="{{URL::asset('assets/images/small/img-4.jpg')}}" data-holder-rendered="true">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="card-body">
                ...
                <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                        <img class="rounded avatar-sm" src="{{URL::asset('assets/images/users/avatar-3.jpg')}}" alt="Generic placeholder image">
                    </div>
                ...
                <div class="d-flex align-items-center">
                    <div class="flex-shrink-0 me-3">
                        <img class="rounded avatar-sm" src="{{URL::asset('assets/images/users/avatar-5.jpg')}}" alt="Generic placeholder image">
                    </div>
                    <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-end">
                    <div class="flex-shrink-0 me-3">
                        <img class="rounded avatar-sm" src="{{URL::asset('assets/images/users/avatar-1.jpg')}}" alt="Generic placeholder image">
                    </div>
                    <div class="flex-grow-1">
